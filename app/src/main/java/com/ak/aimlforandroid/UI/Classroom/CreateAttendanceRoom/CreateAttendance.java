...
import com.ak.aimlforandroid.UI.Classroom.Service.AttendanceService;
    ...
    private void startAtten() {
        ...
        countDownTimer = new CountDownTimer(Integer.parseInt(time)*60*1000, 1000) {
            public void onTick(long millisUntilFinished) {
                Constants.CLASSROOM_DB.child(classID).child(Constants.ATTEN_ROOM).child("time").setValue(String.valueOf(millisUntilFinished/60000)+":"+String.format("%d",(millisUntilFinished%60000)/1000));
            }
